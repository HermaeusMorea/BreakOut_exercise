...
void Game::Init()
{
    ...
    Shader particle_shader = ResourceManager::GetShader("particle");
    Particles = new ParticleGenerator(particle_shader, ResourceManager::GetTexture("particle"), 500);
    Shader postprocessing_shader = ResourceManager::GetShader("postprocessing");
    Effects = new PostProcessor(postprocessing_shader, this->Width, this->Height);
    // load levels
